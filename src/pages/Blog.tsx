...
export function BlogPage() {
  const defaultBlogPosts = [
    ...
    },
    {
      ...
      excerpt:
        "Fasting is more than abstaining from food—it's a spiritual discipline that helps us focus on God and strengthen our faith. Discover the Orthodox perspective on fasting and its transformative power.",
      author: "ዓጋፔ ኦርቶዶክስ",
      date: "October 8, 2025",
      image:
        "https://images.unsplash.com/photo-1638371944196-5384528dc373?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxob2x5JTIwYmlibGUlMjBwcmF5ZXJ8ZW58MXx8fHwxNzYyNzU5NDA1fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    },
    {
      ...
      excerpt:
        "The lives of saints offer us examples of faith, perseverance, and devotion. Learn how studying the lives of saints can inspire and guide us in our own spiritual journey.",
      author: "ዓጋፔ ኦርቶዶክስ",
    ...
    },
    {
      ...
      excerpt:
        "In today's world, maintaining strong family bonds can be challenging. Discover how Orthodox Christian principles can help create a loving, faith-centered family environment.",
      author: "ዓጋፔ ኦርቶዶክስ",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-blue-100 text-lg">
              Read our latest spiritual insights, biblical reflections, and
              teachings on Orthodox Christian living. These articles are
              designed to encourage and deepen your faith walk.
            </p>
          </div>
        </div>
      </section>
